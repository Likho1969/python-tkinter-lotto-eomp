...
class Play:
    ...
    def luck(self):
        ...
        self.my_list = [a, a, a, a, a, a]
        self.my_list.sort()

        self.my_list2 = [b, b, b, b, b, b]
        self.my_list2.sort()

        self.my_list3 = [c, c, c, c, c, c]
        self.my_list3.sort()

        self.todaylotto = sorted(random.sample(range(1, 49), 6))

        if any(self.my_list) < 0 or any(self.my_list) < 50 and any(self.my_list2) < 0 or any(self.my_list2) < 50 and any(self.my_list3) < 0 or any(self.my_list3) < 50:
                ...
                if len(self.todaylotto) == len(self.my_list):
                    ...
                    same2 = set(self.todaylotto).intersection(set(self.my_list2))
                    same3 = set(self.todaylotto).intersection(set(self.my_list3))
                    if len(same or same2 or same3) == 6:
                    ...
                    elif len(same or same2 or same3) == 5:
                    ...
                    elif len(same or same2 or same3) == 4:
                    ...
                    elif len(same or same2 or same3) == 3:
                    ...
                    elif len(same or same2 or same3) == 2:
